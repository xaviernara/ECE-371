...
begin
-----------------input/intermediate signal assignment ----------------------
   ...
   --and_or(2) <= (g(2) and a(3));
	...
	z_or(2) <= g(3) or ((g(2) and a(3)) or (g(1) and a(3) and a(2)) or (g(0) and a(3) and a(2) and a(1)));
------------------------------------------------------
...
-----------------output signal assignment ----------------------
	GA<=(a(0) and a(3) and a(2) and a(1));
	GG<= z_or(2);
	
	c(3)<= (z_or(2) or z_and(3)); 
	c(2)<= (z_or(1) or z_and(2));
	c(1)<= (z_or(0) or z_and(1));
	c(0)<= (g(0) or z_and(0));
	
-- c(3)<= (z_or(2) and z_and(3)); 
