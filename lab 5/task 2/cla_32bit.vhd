...
--   SIGNAL g, a : std_logic_vector(3 downto 0);
--	BEGIN
--	cla0 : ENTITY work.cla_8bit(structure)
--	PORT MAP( x => x(7 downto 0) , y => y(7 downto 0), cin => carries(0),
--	        sum => sum(7 downto 0), cout => OPEN, GG => g(0) , GA=> a(0));
--
--	cla2 : ENTITY work.cla_8bit(structure)
--	PORT MAP(x => x(15 downto 8) , y => y(15 downto 8), cin => carries(1), 
--	        sum => sum(15 downto 8), cout => OPEN, GG => g(1) , GA=> a(1) );
--
--	cla4 : ENTITY work.cla_8bit(structure)
--	PORT MAP( x => x(23 downto 16) , y => y(23 downto 16), cin => carries(2), 
--	        sum => sum(23 downto 16), cout => OPEN, GG => g(2) , GA=> a(2) );
--
--	cla6 : ENTITY work.cla_8bit(structure)
--	PORT MAP( x => x(31 downto 24) , y => y(31 downto 24), cin => carries(3),
--	        sum => sum(31 downto 24), cout => OPEN, GG => g(3) , GA=> a(3));
--
--	cla7 : ENTITY work.clg_4bit(dataflow)
--	PORT MAP(g => g(3 downto 0), a => a(3 downto 0), c0 => carries(0), 
--		 c => carries(4 downto 1), GG => GG, GA => GA);
--
--	cout <= carries(4);
--	carries(0) <= cin;
--END ARCHITECTURE structure;
